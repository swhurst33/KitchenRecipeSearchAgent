...
class PromptEnricher:
    ...
    def process_prompt_for_search(
        self, original_prompt: str, user_context: Dict
    ) -> Dict[str, any]:
        """
        ...
        logger.info(
            f"Completed prompt processing for search: {len(search_keywords)} keywords extracted"
        )
        return result
